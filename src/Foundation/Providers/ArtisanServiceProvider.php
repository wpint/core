...
use Illuminate\Foundation\Providers\ArtisanServiceProvider as ProvidersArtisanServiceProvider;
...
class ArtisanServiceProvider extends ProvidersArtisanServiceProvider
{
    /**
